...
\emph{exploration} (trying others). Lai and Robbins (1985) showed regret must grow at
least logarithmically in the number of plays $n$, but only \emph{asymptotically}. This paper gives efficient
policies achieving logarithmic regret \emph{uniformly over time} -- matching the finite horizon of real-world applications.
...
\begin{figure}[htb]
\centering
\begin{subfigure}[b]{0.235\textwidth}\includegraphics[width=\linewidth,height=3.1cm]{comparison_dist2_ratio.png}\end{subfigure}\hfill
\begin{subfigure}[b]{0.235\textwidth}\includegraphics[width=\linewidth,height=3.1cm]{comparison_dist12_ratio.png}\end{subfigure}\hfill
\begin{subfigure}[b]{0.235\textwidth}\includegraphics[width=\linewidth,height=3.1cm]{comparison_dist13_ratio.png}\end{subfigure}\hfill
\begin{subfigure}[b]{0.235\textwidth}\includegraphics[width=\linewidth,height=3.1cm]{comparison_dist14_ratio.png}\end{subfigure}
...
\begin{figure}[htb]
\centering
\begin{subfigure}[b]{0.235\textwidth}\includegraphics[width=\linewidth,height=3.1cm]{comparison_dist2_regret.png}\end{subfigure}\hfill
\begin{subfigure}[b]{0.235\textwidth}\includegraphics[width=\linewidth,height=3.1cm]{comparison_dist12_regret.png}\end{subfigure}\hfill
\begin{subfigure}[b]{0.235\textwidth}\includegraphics[width=\linewidth,height=3.1cm]{comparison_dist13_regret.png}\end{subfigure}\hfill
\begin{subfigure}[b]{0.235\textwidth}\includegraphics[width=\linewidth,height=3.1cm]{comparison_dist14_regret.png}\end{subfigure}
